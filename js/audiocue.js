...
(function() {
  ...
  define(["cue", "audio", "debug", "ease"], function(Cue, Audio, debug, ease) {
    var AudioCue, FADE_STEP;
    FADE_STEP = 0.01;
    return AudioCue = (function(_super) {
      ...
      AudioCue.prototype.set = function(property, value) {
        return this.properties[property] = value;
      };

      AudioCue.prototype.fade = function(to, time, property, easing) {
        var dt, from, numSteps;
        if (time == null) {
          time = 1;
        }
        if (property == null) {
